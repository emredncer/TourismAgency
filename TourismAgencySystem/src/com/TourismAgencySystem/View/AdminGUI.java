...
public class AdminGUI extends JFrame {
    ...
    private JTextField fld_clicked_user_id;
    ...
    public AdminGUI() {
        ...
        btn_admin_create.addActionListener(e -> {
            if (Helper.isFieldEmpty(fld_admin_user_create_nameLastname) ||
                    ...
                    cmb_user_add.getSelectedItem() == null) {
        ...
        deleteThisUserButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow != -1) {
                    ...
                    selectedUserId = Integer.parseInt(tbl_admin_user_list.getValueAt(selectedRow, 0).toString());
                } else {
